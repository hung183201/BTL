...
namespace WebQLCuaHangThucPham.Areas.Admins.Controllers
{
    public class DonHangsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaDH,Time_Create,Money,MaKH")] DonHang donHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaDH,Time_Create,Money,MaKH")] DonHang donHang)
        {
            if (ModelState.IsValid)
            {
